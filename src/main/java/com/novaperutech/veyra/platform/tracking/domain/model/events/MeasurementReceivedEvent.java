...
public class MeasurementReceivedEvent  extends ApplicationEvent {
   ...
   private final  Integer       respiratoryRate;
    ...
    public MeasurementReceivedEvent(Object source,Long measurementId1, String deviceId1, LocalDateTime timestamp1, Integer heartRate1, Integer systolic1, Integer diastolic1, Double temperature1, Integer oxygenSaturation1, Integer respiratoryRate1) {
        super(source);
